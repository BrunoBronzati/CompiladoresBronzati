 ...
 */
package br.ufscar.dc.alguma.semantico;
...
public class AlgumaSemanticoUtils {
    ...
    public static void adicionarErroSemantico(Token t, String mensagem) {
     ...
     public static TabelaDeSimbolos.TipoAlguma verificarTipo(TabelaDeSimbolos tabela,  AlgumaParser.ExpressaoAritmeticaContext ctx, AlgumaParser.ExpressaoAritmeticaContext ta) {
        TabelaDeSimbolos.TipoAlguma ret = null;
        
        for (AlgumaParser.TermoAritmeticoContext var : ctx.termoAritmetico()) {
    ...
    public static TabelaDeSimbolos.TipoAlguma verificarTipo(TabelaDeSimbolos tabela, AlgumaParser.TermoAritmeticoContext ctx) {
        ...
        for(AlgumaParser.FatorAritmeticoContext var : ctx.fatorAritmetico()) {
            AlgumaParser.TermoAritmeticoContext fa = null;
    ...
    static TabelaDeSimbolos.TipoAlguma verificarTipo(TabelaDeSimbolos tabela, AlgumaParser.ExpressaoAritmeticaContext expressaoAritmetica) {
